...
Consumer.create!(user: hero_user, first_name: 'Bruce', last_name: 'Wayne', city: 'Barcelona', phone_number: '500-500-500', instagram: 'secret_hero', remote_profile_img_url: "http://res.cloudinary.com/dl12g2ws3/image/upload/v1506436950/vurrmapytpds2ximplly.jpg")
